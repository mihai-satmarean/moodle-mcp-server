...
# Script pentru repornirea Moodle MCP Server cu noul tool get_courses
# Nu modifică codul original, doar repornește serverul

echo "🔄 Repornire Moodle MCP Server cu noul tool get_courses..."
echo "📍 CWD: $(pwd)"
...
echo ""
echo "🎯 Repornire MCP Server cu noul tool get_courses..."
echo "📝 Pentru a opri serverul, apasă Ctrl+C"
echo "============================================================"

# Rulează MCP Server-ul cu environment variables setate
export MOODLE_API_URL
export MOODLE_API_TOKEN
export MOODLE_COURSE_ID

echo "🚀 Pornire server cu noul tool get_courses..."
node build/index.js
